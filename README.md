...
### 1. Is it possible to label SUI investors' addresses with high confidence? Team addresses? If no, explain why and provide a detailed answer with your research and hypotheses on the team and investor allocation addresses.
The allegations made on insider trading are rather circumstantial and made with little to no evidence.
Light did not provide a list of wallets and it smells similar to the recent allegations surrounding Justin Sun (which all were circumstantial evidence at best).

In court, circumstantial evidence would not matter, so why should it in public?

Now the base question is. Can wallet from the team or investors be labelled with high accuracy?
